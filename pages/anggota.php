...
<div id="content">
	<p id="tombol-tambah-container">
		<a href="anggota-input.php" class="tombol">Tambah Anggota</a>
			...
			if(mysqli_num_rows($q_tampil_anggota)> 0){
				...
				while ($r_tampil_anggota=mysqli_fetch_array($q_tampil_anggota)) {
					...
					<tr>
						...
						<td>
							<div class="tombol-opsi-container"><a target="_blank" href="cetak-kartu.php?id=<?php echo $r_tampil_anggota['idanggota'];?>" class="tombol">Cetak Kartu</a>
							</div>
							<div class="tombol-opsi-container"><a href="anggota-edit.php?id=<?php echo $r_tampil_anggota['idanggota'];?>" class="tombol">Edit</a>
							</div>
							<div class="tombol-opsi-container"><a href="../proses/anggota-hapus.php?id=<?php echo $r_tampil_anggota['idanggota'];?>" onclick = "return confirm ('Apakah Anda Yakin Akan Menghapus Data Ini?')" class="tombol">Hapus</a>
							</div>
						</td>
					</tr>
					<?php 
